...
hl.config({
  scrolling = {
    ...
    -- Sets the width of a single window/column relative to the viewport (e.g., 0.5 is exactly half screen)
    column_width = 0.49,
    -- Sets how much of the edge of an adjacent window must be visible to be considered selectable
    -- Lowering this lets you "see" the edge of the next window while focusing the current one
    follow_min_visible = 0.2,
    -- Defines how the layout reacts when a window is focused
